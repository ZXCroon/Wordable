main: util.o info.o basic.o def.o env.o interaction.o progress.o sentences.o stats.o strategy.o test.o main_interface.o program.o user.o
	g++ -o final util.o info.o basic.o def.o env.o interaction.o progress.o sentences.o stats.o strategy.o test.o user.o main_interface.o program.o
...
program.o: program.cpp info.h interaction.h env.h strategy.h user.h
	g++ -c -g program.cpp
